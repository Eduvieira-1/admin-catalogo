...
public class CategoryTest {
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenReturnCategoryInactivated() {
        ...
        final var expectedIsActiveBefore = true;
        final var expectedIsActiveAfter = false;

        final var aCategory = Category.newCategory(expectedName, expectedDescription, expectedIsActiveBefore);
        ...
        Assertions.assertEquals(expectedName, actualCategory.getName());
        Assertions.assertEquals(expectedDescription, actualCategory.getDescription());
        Assertions.assertEquals(expectedIsActiveAfter, actualCategory.isActive());
